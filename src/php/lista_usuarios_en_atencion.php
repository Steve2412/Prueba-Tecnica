...
if (isset($_POST["action"])) {
    ...
    //verificar si la acción es "fetch_en_atencion"

    if ($_POST["action"] == "fetch_en_atencion") {

        //Mostrar la lista de usuarios en atención en una tabla
        $output = '
        ...
        <tbody>
';
        //obtener los usuarios en atención de la base de datos
        $query = "SELECT * FROM usuario where usuario_estatus = 2 order by usuario_fecha_atencion asc";
        ...
        if ($result) {
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-select form-select-sm select-estado" "
                                ...
                                <option value="3" ' . ($row['usuario_estatus'] == 3 ? 'selected' : '') . '>Atendidos</option>
                            </select>
                        </td>                    
                        </tr>
                ';
            ...
            //si no hay usuarios en atención, mostrar mensaje de no hay informacion
        } else {
            $output .= '
                <tr>
